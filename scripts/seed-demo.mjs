...
const ROLE_PERMS = {
  ...
  VERIFICATEUR: ["operations:agencies:read","operations:counters:read","operations:financial:read","operations:reports:read","operations:reports:export","operations:dashboard:read","operations:verification:read","operations:verification:validate"],
  COMPTABLE_SIEGE: ["operations:agencies:read","operations:financial:read","operations:reports:read","operations:reports:export","operations:dashboard:read","operations:verification:read","operations:fund:manage","treasury:accounts:read","treasury:reports:read"]
};
